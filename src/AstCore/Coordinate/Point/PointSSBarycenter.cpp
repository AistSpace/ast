...
Point *PointSSBarycenter::Instance()
{
    static SharedPtr<PointSSBarycenter> instance(new PointSSBarycenter());
    return instance.get();
}


Frame *PointSSBarycenter::getFrame() const
{
    return aFrameRoot();
}
