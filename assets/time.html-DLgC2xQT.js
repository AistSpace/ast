...
<span class="line"><span>    @defgroup Time 时间转换</span></span>
<span class="line"><span>    @brief 提供儒略日、日期时间等时间表示，以及不同时间系统之间的转换功能</span></span>
<span class="line"><span>    @{</span></span>
<span class="line"><span>*/</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/*!</span></span>
<span class="line"><span>    @addtogroup Time 时间模块</span></span>
<span class="line"><span>    @{</span></span>
<span class="line"><span>*/</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 将日期转换为字符串表示</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>A_ALWAYS_INLINE int aDateToMJD(int year, int month, int day){</span></span>
<span class="line"><span>    return aDateToMJD({year, month, day});</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>/*! @} */</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>/*!</span></span>
<span class="line"><span>    @addtogroup Time</span></span>
<span class="line"><span>    @{</span></span>
<span class="line"><span>*/</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 获取今日00:00:00 UTC日期时间</span></span>
<span class="line"><span>/// @param dttm </span></span>
<span class="line"><span>/// @return </span></span>
<span class="line"><span>AST_CORE_CAPI void aTodayDateTimeUTC(DateTime&amp; dttm);</span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 获取明天00:00:00 UTC日期时间</span></span>
<span class="line"><span>/// @param dttm </span></span>
<span class="line"><span>/// @return </span></span>
<span class="line"><span>AST_CORE_CAPI void aTomorrowDateTimeUTC(DateTime&amp; dttm);</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// --------------------</span></span>
<span class="line"><span>// 日期时间规范化</span></span>
<span class="line"><span>// --------------------</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// -------------</span></span>
<span class="line"><span>// 日期时间递增</span></span>
<span class="line"><span>// -------------</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// -------------</span></span>
<span class="line"><span>// 日期时间格式化</span></span>
<span class="line"><span>// -------------</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @return errc_t </span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeFormat(const DateTime&amp; dttm, StringView format, std::string&amp; str);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param str </span></span>
<span class="line"><span>/// @return errc_t </span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeFormatGregorian(const DateTime&amp; dttm, std::string&amp; str, int precision = 3);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param str </span></span>
<span class="line"><span>/// @return errc_t </span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeFormatGregorianEn(const DateTime&amp; dttm, std::string&amp; str);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param str </span></span>
<span class="line"><span>/// @return errc_t </span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeFormatGMT(const DateTime&amp; dttm, std::string&amp; str);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param str </span></span>
<span class="line"><span>/// @return errc_t </span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeFormatISO8601(const DateTime&amp; dttm, std::string&amp; str);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 格式化日期时间为简单ISO 8601格式</span></span>
<span class="line"><span>/// @details 将日期时间对象格式化为ISO 8601格式的字符串，例如：2025-11-21T12:34:56Z</span></span>
<span class="line"><span>A_ALWAYS_INLINE errc_t aDateTimeFormatISO(const DateTime&amp; dttm, std::string&amp; str)</span></span>
<span class="line"><span>{</span></span>
...
<span class="line"><span>/// @param str </span></span>
<span class="line"><span>/// @return errc_t </span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeFormatRFC3339(const DateTime&amp; dttm, std::string&amp; str);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param str </span></span>
<span class="line"><span>/// @return errc_t </span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeFormatRFC1123(const DateTime&amp; dttm, std::string&amp; str);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param str </span></span>
<span class="line"><span>/// @return errc_t </span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeFormatRFC2822(const DateTime&amp; dttm, std::string&amp; str);</span></span>
<span class="line"><span></span></span>
<span class="line"><span>#endif</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 格式化日期时间为默认格式</span></span>
<span class="line"><span>/// @details 将日期时间对象格式化为默认格式的字符串，例如：2025-11-21 12:34:56.123</span></span>
<span class="line"><span>/// @param dttm </span></span>
<span class="line"><span>/// @param str </span></span>
<span class="line"><span>/// @return errc_t </span></span>
<span class="line"><span>A_ALWAYS_INLINE errc_t aDateTimeFormatDefault(const DateTime&amp; dttm, std::string&amp; str, int precision = kTimeDefaultFormatPrecision)</span></span>
<span class="line"><span>{</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// -------------</span></span>
<span class="line"><span>// 日期时间解析</span></span>
<span class="line"><span>// -------------</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @return errc_t 错误码，eNoError表示成功</span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeParseISO8601(StringView str, DateTime&amp; dttm);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>A_ALWAYS_INLINE errc_t aDateTimeParseISO(StringView str, DateTime&amp; dttm)</span></span>
<span class="line"><span>{</span></span>
...
<span class="line"><span>/// @param dttm 输出参数，解析后的日期时间对象</span></span>
<span class="line"><span>/// @return errc_t 错误码，eNoError表示成功</span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeParseRFC3339(StringView str, DateTime&amp; dttm);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param dttm 输出参数，解析后的日期时间对象</span></span>
<span class="line"><span>/// @return errc_t 错误码，eNoError表示成功</span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeParseGregorian(StringView str, DateTime&amp; dttm);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param dttm 输出参数，解析后的日期时间对象</span></span>
<span class="line"><span>/// @return errc_t 错误码，eNoError表示成功</span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeParseGregorianEn(StringView str, DateTime&amp; dttm);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param dttm 输出参数，解析后的日期时间对象</span></span>
<span class="line"><span>/// @return errc_t 错误码，eNoError表示成功</span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeParseGMT(StringView str, DateTime&amp; dttm);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param dttm 输出参数，解析后的日期时间对象</span></span>
<span class="line"><span>/// @return errc_t 错误码，eNoError表示成功</span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeParse(StringView str, StringView format, DateTime&amp; dttm);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param dttm 输出参数，解析后的日期时间对象</span></span>
<span class="line"><span>/// @return errc_t 错误码，eNoError表示成功</span></span>
<span class="line"><span>AST_CORE_CAPI errc_t aDateTimeParseAny(StringView str, DateTime&amp; dttm);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 从字符串解析日期时间（任意格式）</span></span>
<span class="line"><span>    /// @param str 包含日期时间的字符串</span></span>
<span class="line"><span>    /// @return DateTime 解析后的日期时间对象</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>    /// @brief 获取 J2000.0 历元的儒略日对象</span></span>
<span class="line"><span>    static JulianDate J2000(){</span></span>
<span class="line"><span>        return JulianDate::FromDaySecond(static_cast&lt;int&gt;(kJ2000Epoch), 0.0);</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>    AST_CORE_API</span></span>
...
<span class="line"><span>        return daysFromJ2000() / kDaysPerJulianCentury;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>    /// @brief 计算儒略日与 J2000.0 历元的时间差（儒略日）</span></span>
<span class="line"><span>    double daysFromJ2000() const{</span></span>
<span class="line"><span>        return ((day_ - kJ2000Epoch) + dayFractional());</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>    /// @brief 计算儒略日与 J2000.0 历元的时间差（秒）</span></span>
<span class="line"><span>    double secondsFromJ2000() const{</span></span>
<span class="line"><span>        return (day_ - kJ2000Epoch) * kSecondsPerDay + second_;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>public:</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>public:</span></span>
<span class="line"><span>    /// @brief 计算儒略日偏移后的新儒略日</span></span>
<span class="line"><span>    /// @param second 偏移秒数</span></span>
<span class="line"><span>    /// @return 偏移后的新儒略日</span></span>
<span class="line"><span>    JulianDate shiftedBySecond(double second) const{</span></span>
<span class="line"><span>        return JulianDate::FromDaySecond(day_, second_ + second);</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>public:</span></span>
...
<span class="line"><span>        return minusInSecond(other);</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 时长减法方法（秒）</span></span>
<span class="line"><span>    /// @param other 另一个时长</span></span>
<span class="line"><span>    /// @return 两个时长的差值（秒数）</span></span>
<span class="line"><span>    double minusInSecond(const LongDuration&amp; other) const{</span></span>
<span class="line"><span>        return (integer_ - other.integer_) + (fractional_ - other.fractional_);</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 时长减法方法（分钟）</span></span>
<span class="line"><span>    /// @param other 另一个时长</span></span>
<span class="line"><span>    /// @return 两个时长的差值（分钟数）</span></span>
<span class="line"><span>    double minusInMinute(const LongDuration&amp; other) const{</span></span>
<span class="line"><span>        return (integer_ - other.integer_) / kSecondsPerMinute + (fractional_ - other.fractional_) / kSecondsPerMinute;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    double minusInHour(const LongDuration&amp; other) const{</span></span>
<span class="line"><span>        return (integer_ - other.integer_) / kSecondsPerHour + (fractional_ - other.fractional_) / kSecondsPerHour;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    /// @brief 时长减法方法（天）</span></span>
<span class="line"><span>    /// @param other 另一个时长</span></span>
<span class="line"><span>    /// @return 两个时长的差值（天数）</span></span>
<span class="line"><span>    double minusInDay(const LongDuration&amp; other) const{</span></span>
<span class="line"><span>        return (integer_ - other.integer_) / kSecondsPerDay + (fractional_ - other.fractional_) / kSecondsPerDay;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>public:</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>AST_CORE_API void aTDBToTT(const JulianDate&amp; jdTDB, JulianDate&amp; jdTT);</span></span>
<span class="line"><span>AST_CORE_API void aTDBToTT(const DateTime&amp; dttmTDB, DateTime&amp; dttmTT);</span></span>
<span class="line"><span>A_ALWAYS_INLINE JulianDate aTDBToTT(const JulianDate&amp; jdTDB)</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>    JulianDate jdTT;</span></span>
<span class="line"><span>    aTDBToTT(jdTDB, jdTT);</span></span>
<span class="line"><span>    return jdTT;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>A_ALWAYS_INLINE DateTime aTDBToTT(const DateTime&amp; dttmTDB)</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>    DateTime dttmTT;</span></span>
<span class="line"><span>    aTDBToTT(dttmTDB, dttmTT);</span></span>
<span class="line"><span>    return dttmTT;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>/// @param jdTT 地球时(TT)</span></span>
<span class="line"><span>/// @warning 注意输入的时间必须是 地球时(TT) 时间</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 计算 地球时(TT) 时间与 质心动力学时(TDB) 时间的差值</span></span>
<span class="line"><span>/// @param jdTDB 质心动力学时(TDB)</span></span>
<span class="line"><span>/// @warning 注意输入的时间必须是 质心动力学时(TDB) 时间</span></span>
<span class="line"><span>/// @return 地球时(TT) 时间与 质心动力学时(TDB) 时间的差值</span></span>
<span class="line"><span>AST_CORE_CAPI double aTTMinusTDB(const JulianDate&amp; jdTDB);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 将 SPICE 时间转换为 TimePoint</span></span>
<span class="line"><span>/// @param et SPICE 时间（秒）</span></span>
<span class="line"><span>/// @return 对应的 TimePoint 实例</span></span>
<span class="line"><span>AST_CORE_API TimePoint aSpiceEtToTimePoint(double et);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/// @brief 将 TimePoint 转换为 SPICE 时间</span></span>
<span class="line"><span>/// @param tp TimePoint 实例</span></span>
<span class="line"><span>/// @return 对应的 SPICE 时间（秒）</span></span>
<span class="line"><span>AST_CORE_API double aTimePointToSpiceEt(const TimePoint&amp; tp);</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>/*! @} */</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>AST_NAMESPACE_END</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,30)])])}const r=n(e,[["render",p]]),v=JSON.parse('{"path":"/en/core/time.html","title":"Time Module","lang":"en-US","frontmatter":{"description":"Time Module Note: This document is AI-translated. For specific APIs and behaviors, please refer to the source code. Module Overview The Time module provides comprehensive time h...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Time Module\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-01-21T11:03:44.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"space-ast\\",\\"url\\":\\"https://github.com/space-ast\\"}]}"],["meta",{"property":"og:url","content":"https://github.com/space-ast/ast/ast/en/core/time.html"}],["meta",{"property":"og:site_name","content":"🛰️Aerospace Simulation Algorithm"}],["meta",{"property":"og:title","content":"Time Module"}],["meta",{"property":"og:description","content":"Time Module Note: This document is AI-translated. For specific APIs and behaviors, please refer to the source code. Module Overview The Time module provides comprehensive time h..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:locale:alternate","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-01-21T11:03:44.000Z"}],["meta",{"property":"article:modified_time","content":"2026-01-21T11:03:44.000Z"}],["link",{"rel":"alternate","hreflang":"zh-cn","href":"https://github.com/space-ast/ast/ast/core/time.html"}]]},"git":{"createdTime":1766146129000,"updatedTime":1768993424000,"contributors":[{"name":"axel","username":"axel","email":"space_ast@163.com","commits":2,"url":"https://github.com/axel"}]},"readingTime":{"minutes":1.24,"words":371},"filePathRelative":"en/core/time.md","autoDesc":true}');export{r as comp,v as data};
