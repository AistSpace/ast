...
/// @brief  天体MOD轴系
class AST_CORE_API AxesBodyMOD : public AxesBodyRelated
{
public:
    static PAxesBodyMOD New(CelestialBody* body);
    static HAxesBodyMOD NewShared(CelestialBody* body);
