...
#include "nrlmsise-00.hpp"   /* header for nrlmsise-00.h */

#if defined NRLMSISE00_CONST && defined NRLMSISE00_CONST_STRICT
	#undef NDEBUG
	#include <assert.h>  
#endif // NRLMSISE00_CONST
...
extern "C" {
	/* POWER7 */
	extern NRLMSISE00_CONST double pt[150];
	extern NRLMSISE00_CONST double pd[9][150];
	extern NRLMSISE00_CONST double ps[150];
	extern NRLMSISE00_CONST double pdl[2][25];
	extern NRLMSISE00_CONST double ptl[4][100];
	extern NRLMSISE00_CONST double pma[10][100];
	extern NRLMSISE00_CONST double sam[100];

	/* LOWER7 */
	extern NRLMSISE00_CONST double ptm[10];
	extern NRLMSISE00_CONST double pdm[8][10];
...
double NRLMSISE00_FUNC densm (double alt, double d0, double xm, double *tz, int mn3, double *zn3, double *tn3, double *tgn3, int mn2, double *zn2, double *tn2, double *tgn2) {
...
double NRLMSISE00_FUNC densu (double alt, double dlb, double tinf, double tlb, double xm, double alpha, double *tz, double zlb, double s2, int mn1, double *zn1, double *tn1, double *tgn1) {
...
/*    Eq. A24d */
__inline_double g0(double a, NRLMSISE00_CONST double *p) {
...
/*    Eq. A24a */
__inline_double sg0(double ex, NRLMSISE00_CONST double *p, double *ap) {
...
double NRLMSISE00_FUNC globe7(NRLMSISE00_CONST double *p, struct nrlmsise_input *input, struct nrlmsise_flags *flags) {
...
/*      plg[1][8] = (15.0*c*plg[1][7]-8.0*plg[1][6])/7.0; */
	...
	if (flags->sw[9]==-1) {
		...
		if (p[51]!=0) {
			...
			if (p[24]<1.0E-4)
			#if defined NRLMSISE00_CONST && defined NRLMSISE00_CONST_STRICT
				assert(false && "change const global variable", );
			#else
				((double*)p)[24] = 1.0E-4;
			#endif // NRLMSISE00_CONST
...
double NRLMSISE00_FUNC glob7s(NRLMSISE00_CONST double *p, struct nrlmsise_input *input, struct nrlmsise_flags *flags) {
...
void NRLMSISE00_FUNC gtd7(struct nrlmsise_input *input, struct nrlmsise_flags *flags, struct nrlmsise_output *output) {
	double xlat;
	double xmm;
	int mn3 = 5;
...
void NRLMSISE00_FUNC gtd7d(struct nrlmsise_input *input, struct nrlmsise_flags *flags, struct nrlmsise_output *output) {
...
void NRLMSISE00_FUNC ghp7(struct nrlmsise_input *input, struct nrlmsise_flags *flags, struct nrlmsise_output *output, double press) {
...
void NRLMSISE00_FUNC gts7(struct nrlmsise_input *input, struct nrlmsise_flags *flags, struct nrlmsise_output *output) {
