...
BlockDivide::BlockDivide()
    ...
    , outputBuffer_(0.0)
{
    static auto identifier_numerator = aIdentifier("x1");
    static auto identifier_denominator = aIdentifier("x2");
...
errc_t BlockDivide::run(const SimTime &simTime)
{
    ...
    *output_ = (*numerator_) / (*denominator_);
    return eNoError;
}
