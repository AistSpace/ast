...
errc_t AxesICRF::getTransform(const TimePoint &tp, Rotation &rotation) const
{
    rotation = Rotation::Identity();
    return eNoError;
}

errc_t AxesICRF::getTransform(const TimePoint &tp, KinematicRotation &rotation) const
{
