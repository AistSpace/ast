...
/// @brief 计算维度幅角平均变化率(平近点角变化率 + 近点幅角变化率)
/// @param gm 天体的引力参数
/// @param j2 天体的J2项
/// @param rb 天体的半径
/// @param a 轨道的半长轴
...
/// @param inc 轨道的倾角
/// @return 轨道平近点幅角变化率
AST_CORE_CAPI double aMeanArgLatRate(double gm, double j2, double rb, double a, double ecc, double inc);
